...
local function CreateSplash()
    ...
    Title.Text = "BEE HUB 🐝"
    Title.TextColor3 = Color3.fromRGB(255, 255, 0) -- YELLOW
    Title.TextSize = 20
    
    task.wait(3)
    ScreenGui:Destroy()
end
task.spawn(CreateSplash)
...
local BASE = 'https://raw.githubusercontent.com/joustingmatch/BEE HUB 🐝/main/games/'
...
if file then
    pcall(function()
        ...
        httpRequest({
            Url = "https://beehub-track.beehub-hub.workers.dev/hit",
            Method = "POST"
        })
    end)
